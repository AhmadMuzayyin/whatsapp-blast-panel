                            ...
                            <li>
                                <a class="dropdown-item" href="#">
                                    <div class="d-flex flex-row align-items-center gap-2">
                                        <img src="{{ url('assets/images/avatars/06.png') }}" alt=""
...
@push('js')
    <script>
        function toggleTheme() {
            ...
            const currentTheme = htmlTag.classList.contains('dark-theme') ? 'dark-theme' : 'light-theme';
        ...
        $(document).ready(function() {
            ...
            if (theme === 'dark-theme') {
                document.querySelector('.mode-icon').innerHTML = '<ion-icon name="sunny-sharp"></ion-icon>';
            } else {
                document.querySelector('.mode-icon').innerHTML = '<ion-icon name="moon-sharp"></ion-icon>';
            }
        });
    </script>
@endpush
